...
<body>
 ...
 <?php
    ...
    $req = "SELECT media.id_media,ROUND(AVG(note.note),1) as moy_note,media.image,media.titre,media.genre,media.resume FROM media LEFT JOIN note ON note.note_media=media.id_media where titre like '%".$search."%' OR resume like '%".$search."%' OR genre like '%".$search."%'  && del_media!=1 GROUP BY id_media"; 
