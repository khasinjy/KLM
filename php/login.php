         ...
         <div class="container">
            <div class="sign-up-content">
               <form method="POST" action='login_check.php'>
                  ...
                  <div class="form-textbox">
                     <input type="submit" name="check" id="submit" class="submit" value="Connexion" />
                  </div>
               </form>

               <p class="loginhere">
                  Pas de compte ? <a href="login_create.php" class="loginhere-link">Créer</a>
               </p>
               <p class="loginhere">
                  Mot de passe oublié ? <a href="email_check.php" class="loginhere-link">Cliquez-ici</a>
               </p>
            </div>
         </div>
      </div>
